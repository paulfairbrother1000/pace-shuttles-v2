...
type TomorrowMetadata={first_name:string;country_name:string;pickup_name:string;destination_name:string;outbound_pickup_time_label:string;outbound_arrival_by_time_label:string;return_pickup_time_label:string;return_arrival_by_time_label:string;adult_count:number;child_count:number;infant_count:number;captain_full_name:string;captain_surname:string;vehicle_type:string;vehicle_name:string;wet_destination:boolean};
...
function hasTomorrowMetadata(value:unknown):value is TomorrowMetadata{
 ...
 const strings=['first_name','country_name','pickup_name','destination_name','outbound_pickup_time_label','outbound_arrival_by_time_label','return_pickup_time_label','return_arrival_by_time_label','captain_full_name','captain_surname','vehicle_type','vehicle_name'];
